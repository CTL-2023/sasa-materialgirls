...
S = 10000
file_directory = "/Users/nicol/Documents/Python_Projects/CTL_II/SASA"
...
def application_1():
    for i in range(10):
        D = 3
        generate_system(50, D)
        N, coordinates = read_csv_file()
        R = 0.02*(i+1)

        print(a := estimate_volume_fraction(N, R, S, D, coordinates))
        print(b := 1 - math.exp(-N * 4/3 * math.pi * R**3))
        print(a-b)
        print()
...
def application_5():
    for i in range(10):
        ...
        print(a := estimate_volume_fraction(N, R, S, D, coordinates))
        print(b := 1 - math.exp(-N * math.pi * R**2))
        print(a-b)
        print()
